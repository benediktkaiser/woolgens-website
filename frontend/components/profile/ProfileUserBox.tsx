            ...
            <div className="overflow-hidden relative h-52 rounded-lg">
                ...
                <div className="flex absolute top-0 left-0 items-center px-8 pt-4">
                    ...
                    <div>
                        ...
                        <div className="overflow-hidden mt-2 w-80 rounded-full bg-dark-light/50">
                            <div className="py-0.5 pl-4 text-sm leading-none text-gray-100 bg-green-500 rounded-l-full"
                                style={{width: `${getLevelProgressPercentage(user.minecraftUser.seasons[seasonNumber].level, user.minecraftUser.seasons[seasonNumber].exp)}%`}}> Level {user.minecraftUser.seasons[seasonNumber].level}
                            </div>
                        </div>
                    </div>
                </div>
