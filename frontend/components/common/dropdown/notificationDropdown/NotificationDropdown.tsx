...
const NotificationDropdown: FC<NotificationDropDownProps> = ({ notifications }) => {
    ...
    return (
        <Menu as="div" className="inline-block relative text-left">
            ...
            >
                <Menu.Items className="overflow-hidden absolute right-0 p-3 mt-3 w-80 bg-dark rounded-md ring-1 ring-black ring-opacity-5 shadow-lg origin-top-right focus:outline-none">
                    {notifications ? (
