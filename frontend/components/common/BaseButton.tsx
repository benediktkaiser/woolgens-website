...
const BaseButton= ({ type, children, htmlType = "button", ...HTMLAttributes}: BaseButtonProps) => {
    ...
    const colors = {
        ...
        "dark-light": "text-white bg-shark-200 hover:bg-shark-100 focus:ring-dark-light disabled:hover:bg-dark-light",
